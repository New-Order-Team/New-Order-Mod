...
function Definitions()
	...
	-- First Task Force
	{
		...
		,"Frigate | Capital | Dreadnought | Corvette | Bomber | Fighter = 100%"
	},
	{
		"GroundForce"
		,"MinimumTotalSize = 4"
	...
	RequiredCategories = { "Infantry", "Corvette | Frigate | Capital | Dreadnought" }		--Must have at least one ground unit, also make sure space force is reasonable
